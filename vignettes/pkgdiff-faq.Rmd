...
breaking release.  See the vignette `pkgdiff-stability` for a complete 
...
About 16% of the top CRAN downloads have been cached.  This subset constitutes
...
see the vignette "pkgdiff-cache".
