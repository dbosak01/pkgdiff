...
These releases will still be shown in the Stability Data, however, as these older 
releases help to give you an accurate understanding of the package history.

## Stability Assessment

In addition to the above Stability Score, the `pkg_stability()` function also provides
a \strong{Stability Assessment}.  The \strong{Stability Assessment} is a categorization of
the \strong{Stability Score}.  The Stability Assessment is a way to give you an
...
A high stability score is something that package developers should be proud of, 
and programmers should look for when selecting packages to use in their programs.
